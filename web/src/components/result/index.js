        ...
        return (
            <div>
                ...
                <Grid style={{marginTop:"30px"}}>
                    ...
                    <Row>
                        <Col className={!this.props.userInfos.showToolsMode?"left-bar":"left-bar hide"} sm={9} md={9}
                             lg={9}>
                        ...
                        <Col className={!this.props.userInfos.showToolsMode?"right-bar":"right-bar showFull"} sm={3}
                             md={3} lg={3}>
